...
RUN wget -q https://downloads.mariadb.com/Connectors/java/connector-java-2.7.3/mariadb-java-client-2.7.3.jar && \
    wget -q https://nexus.pentaho.org/content/groups/omni/org/pentaho/reporting/engine/classic-core/9.4.0.0-343/classic-core-9.4.0.0-343.jar && \
    wget -q https://nexus.pentaho.org/content/groups/omni/org/pentaho/reporting/engine/classic-extensions/9.4.0.0-343/classic-extensions-9.4.0.0-343.jar && \
    wget -q https://nexus.pentaho.org/content/groups/omni/org/pentaho/reporting/engine/classic-extensions-mondrian/9.4.0.0-343/classic-extensions-mondrian-9.4.0.0-343.jar && \
    wget -q https://nexus.pentaho.org/content/groups/omni/org/pentaho/reporting/engine/classic-extensions-olap4j/9.4.0.0-343/classic-extensions-olap4j-9.4.0.0-343.jar && \
    wget -q https://nexus.pentaho.org/content/groups/omni/org/pentaho/reporting/engine/classic-extensions-kettle/9.4.0.0-343/classic-extensions-kettle-9.4.0.0-343.jar && \
    wget -q https://nexus.pentaho.org/content/groups/omni/org/pentaho/reporting/engine/classic-extensions-scripting/9.4.0.0-343/classic-extensions-scripting-9.4.0.0-343.jar && \
    wget -q https://nexus.pentaho.org/content/groups/omni/org/pentaho/reporting/engine/classic-extensions-drill-down/9.4.0.0-343/classic-extensions-drill-down-9.4.0.0-343.jar
